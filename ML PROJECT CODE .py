...
def DecisionTree():
    ...
    l2=[0]*len(l1) #we added this line to be sure that will be reset after click on decisin tree button
...
def randomforest():
    ...
    print(accuracy_score(y_test, y_pred,normalize=False))
    # -----------------------------------------------------
    l2=[0]*len(l1) #we added this line to be sure that will be reset after click on randomforest button
    psymptoms = [Symptom1.get(),Symptom2.get(),Symptom3.get(),Symptom4.get(),Symptom5.get()]
...
def NaiveBayes():
    ...
    print(accuracy_score(y_test, y_pred,normalize=False))
    # -----------------------------------------------------
    l2=[0]*len(l1) #we added this line to be sure that will be reset after click on NaiveBayes button
    psymptoms = [Symptom1.get(),Symptom2.get(),Symptom3.get(),Symptom4.get(),Symptom5.get()]
    for k in range(0,len(l1)):
        for z in psymptoms:
            if(z==l1[k]):
...
w2 = Label(root, justify=LEFT, text="A Project by Body Safe TEAM", fg="white", bg="black")
